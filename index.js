...
client.on(Events.MessageCreate, async (message) => {
    ...
    try {
        ...
        // Conversión a PCM 48kHz Stereo usando prism.FFmpeg
        ...
        // Usar inlineVolume obliga al reproductor a procesar los paquetes a tiempo real
        const recursoAudio = createAudioResource(audioPipe, {
            inputType: StreamType.Raw,
            inlineVolume: true
        });

        // Establecer el volumen al 100% (1.0)
...
client.on(Events.MessageCreate, async (message) => {
    ...
    try {
        ...
        // Transformación mediante prism-media (bajo consumo de memoria)
        const ffmpegStream = new prism.FFmpeg({
            args: [
                "-i", "pipe:0",
                "-f", "s16le",
        ...
        console.log("🎧 Creando recurso de audio con Prism...");
